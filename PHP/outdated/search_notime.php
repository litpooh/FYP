...
if ($action == "search") {
    ...
    $sql = "SELECT cp_id, district_id, address_en, lat, lgt, waste_type, legend, accessibility_notes, contact_en, openhour_en   FROM CollectionPoints WHERE "  . implode(' AND ', $likes);
