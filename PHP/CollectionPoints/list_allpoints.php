...
if ($action == "list_allpoints") {
    ...
    $sql_points = "SELECT cp_id, cp_state, district_id, address_en, lat, lgt, waste_type, legend, accessibility_notes, contact_en, openhour_en, mon_start, mon_end, tue_start, tue_end, wed_start, wed_end, thurs_start, thurs_end, fri_start, fri_end, sat_start, sat_end, sun_start, sun_end   FROM CollectionPoints";
