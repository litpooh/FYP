...
struct Filter2_Separate_Previews: PreviewProvider {
...
//    @State static var filtered = false
    ...
    static var previews: some View {
        Filter2_Separate(userLocation: CLLocationCoordinate2D(latitude: 0, longitude: 0))
    }
}
