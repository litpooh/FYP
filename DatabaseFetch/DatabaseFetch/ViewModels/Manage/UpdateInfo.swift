...
class SelectedTypes: ObservableObject {
    @Published var types = Set<String>()
}

struct WeekdayOpeningHours{
    var open:Bool
    var openAllDay:Bool
    var startTime:Date
//    var startTime:Date {
...
struct UpdateInfo: View {
    ...
    // @State var new_point:CollectionPointString
    @State var new_point:CollectionPointString = CollectionPointString()
    // Need to set default for the point
    @StateObject var selected_types = SelectedTypes()
    // @State var selected_legend:String
    @State var selected_legend:String = ""
    // @State var selected_accessbility_note
    @State var selected_accessbility_note:String = ""
    // Not passed yet
...
//    @State var sunday_end = Date()
    ...
    var body: some View {
        // original navigationview{form{}.navigationtitle}.environmentobject
        // removed the navigationview
        ...
        Form {
            ...
            Section(header: Text("Waste Types")) {
                NavigationLink(destination: SelectWasteTypes().environmentObject(selected_types)) {
...
//                }
            ...
            NavigationLink(destination: UpdateResult(new_point: CreatePointToUpdate(new_point: new_point, selected_types: selected_types, selected_legend: selected_legend, selected_accessbility_note: selected_accessbility_note))) {
                Text("Submit changes")
...
//                }
        ...
        .navigationTitle("Update Collection Point")
        .environmentObject(selected_types)
    }
    
    func CreatePointToUpdate(new_point: CollectionPointString, selected_types: SelectedTypes, selected_legend: String, selected_accessbility_note: String) -> CollectionPoint {
