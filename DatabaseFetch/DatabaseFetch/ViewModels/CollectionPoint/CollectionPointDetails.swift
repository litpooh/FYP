...
struct CollectionPointDetails: View {
...
struct CollectionPointDetails_Previews: PreviewProvider {
    static var previews: some View {
        CollectionPointDetails(point: CollectionPointData.init().points[0])
    }
}
